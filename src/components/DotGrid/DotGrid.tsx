...
const DotGrid: React.FC<DotGridProps> = ({
    ...
    const onMove = (e: MouseEvent) => {
      ...
      for (const dot of dotsRef.current) {
        ...
        if (speed > speedTrigger && dist < proximity && !dot._inertiaApplied) {
          ...
          const pushX = (dot.cx - pr.x + vx * 0.004) * falloff;
          const pushY = (dot.cy - pr.y + vy * 0.004) * falloff;
  ...
  return (
    <section className={`pointer-events-none absolute inset-0 h-full w-full ${className}`} style={style}>
